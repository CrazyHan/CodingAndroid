...
public class QBadgeView extends View implements Badge {
    ...
    protected Paint mBadgeHaloPaint;//最外面加一个环
    ...
    private void init() {
        ...
        mBadgeHaloPaint = new Paint();
        mBadgeHaloPaint.setAntiAlias(true);
        mBadgeHaloPaint.setStyle(Paint.Style.STROKE);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mBadgeText != null) {
            ...
            if (mDraggable && mDragging) {
                ...
                drawHalo(canvas, mBadgeCenter,getCustomShadowWidth());
            }
        }
    }

    private int getCustomShadowWidth() {
        return 0;
    }
